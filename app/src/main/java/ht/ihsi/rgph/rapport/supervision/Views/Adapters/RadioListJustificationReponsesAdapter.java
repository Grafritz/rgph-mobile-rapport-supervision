 ...
 */
public class RadioListJustificationReponsesAdapter extends RecyclerView.Adapter<RadioListJustificationReponsesAdapter.DetailRowViewHolder> {

    public int mSelectedItem = -1;
    private List<JustificationReponsesModel> reponseModelList;
    private JustificationReponsesModel reponseModelSelectionner=null;
    ...
    public RadioListJustificationReponsesAdapter(Context context, int typeEvenement, List<JustificationReponsesModel> questionReponseModelList){
    ...
    public void onBindViewHolder(DetailRowViewHolder viewHolder, int position) {
        JustificationReponsesModel row = reponseModelList.get(position);
        viewHolder.bind(row);
    ...
    public JustificationReponsesModel getReponseModelSelectionner() {
        return reponseModelSelectionner;
    }
    public void setReponseModelSelectionner(JustificationReponsesModel reponseModelSelectionner){
        this.reponseModelSelectionner = reponseModelSelectionner;
    }
    //region GETTER / SETTER
    public List<JustificationReponsesModel> getReponseModelList() {
    ...
    public void setFilter(List<JustificationReponsesModel> filteredList){
        reponseModelList =new ArrayList<JustificationReponsesModel>();
    ...
    public class DetailRowViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
        ...
        private JustificationReponsesModel reponseModel;
        private JustificationReponsesModel reponseModelSelectionner;
        ...
        public JustificationReponsesModel getReponseModel() {
            //reponseModel.radioButton = getRadioButton();
            //reponseModel.tReponse = gettReponse();
            return reponseModel;
        }

        public void setReponseModel(JustificationReponsesModel reponseModel) {
            //reponseModel.radioButton = getRadioButton();
            //reponseModel.tReponse = gettReponse();
        ...
        public void onClick(View v) {
            ...
            if( this.typeEvenement != Constant.ACTION_AFFICHER ) {
                ...
                if (onItemClickListener != null) {
                    onItemClickListener.onItemClick(reponseModel);
                }
                mSelectedItem = getAdapterPosition();
                notifyItemRangeChanged(0, reponseModelList.size());
        ...
        public void bind(JustificationReponsesModel row){
            row.radioButton = getRadioButton();
            row.tReponse = gettReponse();
            this.reponseModel = row;
            this.tReponse.setText(row.getLibelle());
    ...
    public interface OnBindViewHolderListener {
        void onBindViewHolder(List<JustificationReponsesModel> questionReponseModelList);
    }

    public interface OnItemClickListener {
        void onItemClick(JustificationReponsesModel entity);
        //void onItemClick_2(QuestionReponseModel entity  );
        //void onItemMenuClick(QuestionReponseModel entity);
    }

    public interface OnItemCheckedChangedListener {
        void OnItemCheckedChangedListener(JustificationReponsesModel entity);
    }
