...
/**
 * Entity mapped to table "AGENT_RAPPORT".
 */
public class AgentRapport {
    ...
    public AgentRapport(Long codeAgent) {
        this.codeAgent = codeAgent;
    }

    public AgentRapport(Long codeAgent, String nomCompletAgent, String commentairesGeneraux , String scoreFinalAtteint, Long ScoreOui1, Long ScoreNon2, Long ScoreMoyennement3, Long ScoreHorsObservation4, Long ScoreUneFois1, Long ScoreAuMoins2Fois2, Long ScoreNon3, String createdBy, String dateCreated) {
        this.codeAgent = codeAgent;
